...
import com.guludai.ui.shiro.MyShiroRealm;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/bootstrap.min.js", "anon");
		filterChainDefinitionMap.put("/README.md", "anon");
		filterChainDefinitionMap.put("/ag/**", "anon");
		...
		// 自定义加载权限资源关系
		List<BaseSecurityResources> resourcesList = baseSecurityResourcesBiz.queryAll();
		for (BaseSecurityResources resources : resourcesList) {
			if (StringUtils.isNotEmpty(resources.getItem())) {
				String permission = "perms[" + resources.getItem() + "]";
				filterChainDefinitionMap.put(resources.getItem(), permission);
			}
		}
