...
public class RocketmqAutoConfiguration {
	...
	private static final Logger logger = org.slf4j.LoggerFactory.getLogger(RocketmqAutoConfiguration.class);
	...
	public DefaultMQProducer defaultProducer() throws MQClientException{
         ...
         */
        producer.start();
        logger.debug("RocketMq defaultProducer Started.");
        return producer;
	}
	...
	public TransactionMQProducer transactionProducer() throws MQClientException{
        ...
        logger.debug("RocketMq TransactionMQProducer Started.");
        return producer;
	}
	/**
